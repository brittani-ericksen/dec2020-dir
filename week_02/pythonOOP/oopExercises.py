...
# print("{}'s contact information: {} {}".format(sonny.name, sonny.email, sonny.phone))

# print("{}'s contact information: {} {}".format(jordan.name, jordan.email, jordan.phone))
...
# car = Vehicle("Subaru", "Legacy", 2015)
# car.print_info()
